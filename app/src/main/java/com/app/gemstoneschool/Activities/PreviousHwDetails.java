...
public class PreviousHwDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_previous_hw_details);
        ...
        title = findViewById(R.id.phwtitledetail);
        description = findViewById(R.id.phwdescdetail);
        status = findViewById(R.id.phwdstatusdetail);
        img = findViewById(R.id.phwimgdetail);
        uploadimage = findViewById(R.id.imgcamera);
        imgselect = findViewById(R.id.imgselect);
        upload = findViewById(R.id.btncamera);
        closeImg = findViewById(R.id.clsimg);
        rel_Layout=findViewById(R.id.relhwstd);


        sp = getSharedPreferences(SHARED_PREF_NAME1, MODE_PRIVATE);//initialization of shareprefference1 object
        srid = sp.getString(KEY_SERIALID, null);//save the content of KEY_name into string


        //toolbar
        toolbar = findViewById(R.id.toolbarprevhwdetails);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        hw_id = getIntent().getExtras().getString("hwid");
        //uploading data to textview coming from back intent//
        ...
        //for uploading image open camera//
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                uploadBitmap(bitmap);
                progress=new ProgressDialog(PreviousHwDetails.this);
...
//                    Log.e(TAG, "File select error", e);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PreviousHwDetails.this);
