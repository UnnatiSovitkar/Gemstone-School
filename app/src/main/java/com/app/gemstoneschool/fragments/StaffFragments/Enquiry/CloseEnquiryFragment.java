...
public class CloseEnquiryFragment extends Fragment {
    RecyclerView recyclerView;
    List<EqCloseModel> list = new ArrayList<>();
    EqCloseAdapter adapter;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.close_enquiry_fragment_staff,container,false);


        //api fetch data

        recyclerView = view.findViewById(R.id.recycler_staff_close_enquiry);
        ...
        private void getData() {
            ...
            String url="https://gemstonews.in/gemstoneerp/apis/teacher/get_enquerylist.php";
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        for(int i=0;i<jsonArray.length();i++) {
                            ...
                            list.add(new EqCloseModel(jsonObject.getString("uid"),
                    ...
                    adapter=new EqCloseAdapter(getContext(),list);
