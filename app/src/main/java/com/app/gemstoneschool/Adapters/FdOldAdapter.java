...
public class FdOldAdapter extends RecyclerView.Adapter<FdOldAdapter.ViewHolder> {

    List<FdOldModel> list;
    public FdOldAdapter(Context context, List<FdOldModel>list){
        this.list=list;
    }
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_fdold_item_design,parent,false);
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            name=itemView.findViewById(R.id.fdold_name);
            desc=itemView.findViewById(R.id.fdold_desc);
            date=itemView.findViewById(R.id.fdold_dt);
            time=itemView.findViewById(R.id.fdold_time);
            srn=itemView.findViewById(R.id.srn_old_fd);
